...
- **Single Submission Constraint**: Candidates who have already applied to a drive see an Already Applied badge directing them to their application tracking studio.
...
- **Job Drive Moderation**: Inspect company job descriptions (Inspect Scope), emergency block drives (Block Drive), or delete inappropriate postings (Delete Job).
